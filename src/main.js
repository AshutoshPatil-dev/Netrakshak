...
function renderSources(c) {
  ...
  c.append(
    ...
    el('div', { class: 'source-grid' }, [
      ...
      ['public.profiles', 'Registered law-enforcement profiles', `${state.officers.length} officers`, 'live', 'Linked to Central Identity & IAM'],
